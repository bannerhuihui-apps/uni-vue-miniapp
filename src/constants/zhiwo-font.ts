 ...
 * — 远程地址须在小程序后台配置「downloadFile 合法域名」（如 game.jyiai.com）。
 * — 或使用本地：`src/static/fonts/qingning-rounded.ttf`，并把下面 USE_REMOTE_FONT 设为 false。
 *
 * 【H5】App.vue 中另有 @font-face；请保持 URL 与本文件 Remote 常量一致。
 */
export const FONT_FAMILY_QINGNING = "QingningRounded";

/** 是否与 zhiwo 一样使用线上 CDN（true：remote；false：走 /static/fonts/ 本地） */
export const QINGNING_USE_REMOTE_FONT = true;

export const QINGNING_FONT_URL_REMOTE =
  "https://game.jyiai.com/static/fonts/qingning-rounded.ttf";
